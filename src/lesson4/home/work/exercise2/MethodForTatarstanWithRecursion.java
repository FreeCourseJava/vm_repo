...
package lesson4.home.work.exercise2;
...
public class MethodForTatarstanWithRecursion {
    public static void main(String[] args) {
        ...
        boolean resultOfSearching = getSearchWithRecursion(tatarstanInterestingYears,randomYear);
    ...
    private static boolean getSearchWithRecursion(int[] arrayForSearching, int valueForSearching) {
        ...
        return getSearchWithRecursion(halfOfArrayForSeaching, valueForSearching);
    }
