//// ########## lesson_1 git lesson_1_home_work.lesson_1_git_exercises.exercise_3.exercise_2 ##########
...
package lesson_1_home_work.lesson_1_git_exercises.exercise_2;

public class char_fool {
...
// В данном случае мы наблюдаем ситуацию автоматического преобрахования примитивных типов данных
...
// 4.1) Автоматическое преобраование значения переменной charExample к типу данных int (символ преобразуется в значение соответсвующее его коду ASCII)
